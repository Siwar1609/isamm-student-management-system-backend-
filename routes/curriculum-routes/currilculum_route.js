import {
  ...
  import { accessByRole, loggedMiddleware } from '../../middlewares/users-middlewares/auth_controller.js'
  ...
  router.patch('/:id', loggedMiddleware, accessByRole(['admin']), updateCurriculum)
  router.delete('/:id',loggedMiddleware, accessByRole(['admin']), deleteCurriculum)
